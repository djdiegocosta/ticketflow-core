...
const pillToneClass: Record<PillTone, string> = {
  ...
  success: "bg-[var(--success-muted)] text-[var(--success-text)] border border-[var(--success-text)]/10",
  info: "bg-[var(--info-muted)] text-[var(--info-text)] border border-[var(--info-text)]/10",
