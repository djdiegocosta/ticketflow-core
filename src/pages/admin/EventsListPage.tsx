...
export function EventsListPage() {
  ...
  const renderCreateAction = () => (
    <PrimaryActionLink to="/admin/eventos/novo">Novo Evento</PrimaryActionLink>
  );
        ...
        <>
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
            {events.map((event) => {
              ...
              return (
                <div
                  key={event.id}
                  className="group flex flex-col overflow-hidden rounded-[var(--radius-lg)] border border-border-subtle bg-[var(--bg-primary)] shadow-sm transition-all duration-300 hover:shadow-lg"
                >
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <a
                                ...
                                className="rounded-[var(--radius-sm)] border border-border-default bg-[var(--bg-primary)]/90 p-2 text-[var(--text-secondary)] backdrop-blur-sm transition-colors hover:text-[var(--accent)]"
                              >
                  ...
                  <div className="flex flex-1 flex-col gap-4 p-4">
                    ...
                    <div className="mt-auto pt-2">
                      ...
                      <div className="h-1.5 w-full overflow-hidden rounded-full bg-[var(--bg-tertiary)]">
                        <div className="h-full rounded-full bg-[var(--accent)] transition-all duration-500 ease-out" style={{ width: `${progress}%` }} />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col items-center justify-between gap-4 border-t border-border-subtle pt-4 sm:flex-row">
            ...
            <div className="flex items-center gap-1">
              <button disabled className="cursor-not-allowed rounded-[var(--radius-sm)] border border-border-default p-2 text-[var(--text-disabled)]">
              ...
              <button disabled className="cursor-not-allowed rounded-[var(--radius-sm)] border border-border-default p-2 text-[var(--text-disabled)]">
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7-7 7" /></svg>
              </button>
            </div>
          </div>
        </>
