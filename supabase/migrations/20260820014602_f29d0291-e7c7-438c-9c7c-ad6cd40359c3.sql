...
-- Ajustar create_pending_sale para delayed ticket creation
...
begin
    ...
    -- 6. Criar Venda com persistência de participantes
    ...
    values (
        ...
        'pix_ticketflow',
        v_sale_code,
        to_jsonb(_participant_names)
    )
    returning id into v_sale_id;

    -- 7. Registrar abandono inicial (convertido)
